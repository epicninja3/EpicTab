...
### Description:
EpicTab is a modern  new tab page to make every one of your tabs productive and helpful! EpicTab incorporates many important and useful features, such as the weather and a calendar.
EpicTab is made with HTML, JS, and CSS

## Features

1. EpicTab features NASA's APOD (Astronomy Picture of the Day), showing a new space-related photo every day. Additionally, you can view a description of the picture.
2. The project also shows the weather, along with an icon representing the general condition in that area.
3. EpicTab also has a timer, allowing you to pause and restart the timer.
   + The timer also has a progress bar that decreases over time.
4. A Google search bar that allows you to search anything using the Google search engine.
5. Customizable bookmark bar allowing you to save any of your favorite websites.
6. A personal greeting that changes based on the time of day.
7. A to-do list allowing you to create new tasks to make your day even more productive!
8. A calendar allowing you to easily view each month.
9. A flight tracker application! Simply type your flight number in the input field and click the search button.
   Contains important information such as:
   + Departure/arrival airport
   + Time until arrival and time since departure
   + Aircraft model and airline
   + Flight Status
10. Customizable background and text that changes based on how bright the background is!
...
+ Background
  ...
  + Click on the file upload icon to upload an image file.
  
+ Preferences
  + Click on "Preferences" in the settings menu
